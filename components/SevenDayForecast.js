            ...
            <View style={styles.container}>
                ...
                {sevenDaysData.map((data) => (
                    ...
                    <View style={styles.forecastBlocks}>
                        <View>
                            <MaterialCommunityIcons name="weather-cloudy" size={64} color="white" />
                            <View  >
                                <Text style={[styles.forecastBlockInfo, styles.dayOfWeek]}>{moment.unix(data.dt).format('dddd')}</Text>
                            </View>
                        </View>
